...
public class PlayVideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        simpleExoPlayerView = (SimpleExoPlayerView) rootView.findViewById(R.id.exo_player_video);

        simpleExoPlayerView.setControllerShowTimeoutMs(20000);
        ...
        if(bundle != null)
        {
            ...
            String videoUrl = recipeSteps.getVideoUrl();
            String thumbnailUrl = recipeSteps.getThumbnailURL();

            if(!videoUrl.equals(""))
            {
                playerSetup(videoUrl );

            }
            else if(!thumbnailUrl.equals(""))
            {
                playerSetup(thumbnailUrl );
            }
            else
            {
                thumbnailUrl = "empty url";
                loadDefaultImage(thumbnailUrl , rootView);
            }
    ...
    public void loadDefaultImage(String imageUrl , View rootView)
    {
    ...
    public void playerSetup(String videoUrl)
    {
